    ...
    <div class="modal-content">
	  ...
	  <p class="lead text-muted text-center" style="display: block;margin:10px">Esta acción eliminará de forma permanente el registro. Deseas continuar?</p>
			<div id="datos_ajax_register"></div>
				...
				<input type="text" class="form-control" id="cedula" name="cedula" required readonly="readonly" maxlength="10">
			</div>cedula
			<div class="form-group col-xs-12">
				<label for="nombre" class="control-label col-xs-12">Apellido y Nombre:</label>
